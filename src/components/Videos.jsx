...
const Videos = ({ lang = 'ar' }) => {
    const t = {
        ar: {
            title: 'شاهد منتجاتنا',
            subtitle: 'اكتشف جمال وجودة نباتاتنا من خلال هذه الفيديوهات',
            watchOnFb: 'اضغط للمشاهدة على فيسبوك',
            facebook: 'فيسبوك',
            ctaQuestion: 'هل أعجبتك منتجاتنا؟',
            ctaButton: 'اطلب الآن عبر واتساب'
        },
        fr: {
            title: 'Regardez nos produits',
            subtitle: 'Découvrez la beauté et la qualité de nos plantes à travers ces vidéos',
            watchOnFb: 'Cliquez pour regarder sur Facebook',
            facebook: 'Facebook',
            ctaQuestion: 'Nos produits vous plaisent ?',
            ctaButton: 'Commandez maintenant via WhatsApp'
        }
    };
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="text-center mb-12">
                    <div className="flex items-center justify-center mb-4">
                        <Play className={`w-10 h-10 text-green-600 ${isFrench ? 'mr-3' : 'ml-3'}`} />
                        <h2 className="text-4xl font-bold text-gray-800">{text.title}</h2>
                    </div>
                    ...
                    {videos.map((video) => (
                        ...
                        >
                            ...
                            <div className="relative aspect-video bg-gradient-to-br from-green-100 to-green-200 overflow-hidden">
                                ...
                                {/* Facebook Badge */}
                                <div className={`absolute top-4 ${isFrench ? 'left-4' : 'right-4'} bg-blue-600 text-white px-3 py-1.5 rounded-full text-sm font-bold flex items-center gap-2 shadow-lg`}>
                                ...
                                {/* External Link Icon */}
                                <div className={`absolute bottom-4 ${isFrench ? 'right-4' : 'left-4'} bg-white/90 backdrop-blur-sm p-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity`}>
                ...
                <div className="text-center mt-12">
                    <p className="text-gray-600 mb-4">{text.ctaQuestion}</p>
                    <a
