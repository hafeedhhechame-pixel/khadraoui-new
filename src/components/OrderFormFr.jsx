...
const OrderFormFr = ({ product }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            googleFormData.append('entry.1760082287', formData.deliveryType === 'home' ? formData.address : 'Livraison au bureau');
            googleFormData.append('entry.1124710778', product.name);
