...
const OrderForm = ({ product, lang = 'ar' }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            googleFormData.append('entry.56909259', formData.name);
            googleFormData.append('entry.1015976622', formData.phone);
            googleFormData.append('entry.591381623', formData.wilaya);
            googleFormData.append('entry.1820347149', formData.commune);
            googleFormData.append('entry.1760082287', formData.deliveryType === 'home' ? formData.address : 'توصيل للمكتب');
            googleFormData.append('entry.1124710778', productName);
            googleFormData.append('entry.92446490', formData.quantity);
            googleFormData.append('entry.1622967126', product.price);
            googleFormData.append('entry.468201108', totalPrice);
            googleFormData.append('entry.1900417879', formData.notes || '-');

            await fetch('https://docs.google.com/forms/d/e/1FAIpQLSeHiVfPTE7oUj5gmVGHFRt6zLj081hSBzYBpgn7wTRZTiazvw/formResponse', {
                method: 'POST',
                mode: 'no-cors',
                body: googleFormData
            });
