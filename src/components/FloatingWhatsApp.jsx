...
const FloatingWhatsApp = () => {
    const phoneNumber = "213799330612";
    const message = "مرحباً، لدي استفسار بخصوص منتجات خضراوي";
    ...
    useEffect(() => {
        ...
        if (savedPosition) {
            ...
            // Default position: bottom-32 right-20
    ...
    return (
        <a
            ...
            className="fixed z-50 bg-[#25D366] hover:bg-[#128C7E] text-white p-6 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 flex items-center justify-center group"
            style={{
                left: `${position.x}px`,
                top: `${position.y}px`,
